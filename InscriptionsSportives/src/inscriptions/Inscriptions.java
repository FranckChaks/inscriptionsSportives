...
public class Inscriptions implements Serializable
{
	...
	public static void main(String[] args)
	{
		...
		Menu equipeMenu = new Menu("Menu des �quipes", "Equipe", "e");
		...
		competitionMenu.add(
			...
			new Option("Cr�er une comp�tition", "1", new Action()
			{
		...
		competitionMenu.add(
			new Option("Modifier une comp�tition", "2", new Action()
			{
				public void optionSelected()
				{
					System.out.println("test");
		...
		competitionMenu.add(
				new Option("Supprimer une comp�tition", "3", new Action()
				{
					public void optionSelected()
					{
						System.out.println("test");
		...
		equipeMenu.add(
				...
				new Option("Ajouter une �quipe", "1", new Action()
				{
						public void optionSelected()
						{
							System.out.println("test");
		...
		equipeMenu.add(
				...
				new Option("Modifier une �quipe", "2", new Action()
				{
						public void optionSelected()
						{
							System.out.println("test");
		...
		equipeMenu.add(
				...
				new Option("Supprimer une �quipe", "3", new Action()
				{
						public void optionSelected()
						{
							System.out.println("test");
